    ...
    extend: {
      ...
      colors: {
        ...
        spidey: {
          ...
          "red-glow": "hsl(var(--spidey-red-glow))",
          blue: "hsl(var(--spidey-blue))",
          "blue-glow": "hsl(var(--spidey-blue-glow))",
          dark: "hsl(var(--spidey-dark))",
          darker: "hsl(var(--spidey-darker))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "node-pulse": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--spidey-red) / 0.4)" },
          "50%": { boxShadow: "0 0 0 12px hsl(var(--spidey-red) / 0)" },
        },
        "shimmer": {
